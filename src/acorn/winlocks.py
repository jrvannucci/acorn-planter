...
Why this exists
---------------
Deleting acorn's tree fails on Windows when another process holds a handle
...
so it stays inside acorn's "nothing pre-installed required" rule.
