"""
`acorn summary` -- one screen showing everything acorn has installed:
...
def collect(want_sizes: bool = False) -> dict:
    ...
    return {
        ...
        # the human output and --json, and acorn tees command output
...
def _render_text(data: dict, want_sizes: bool) -> int:
    print(colors.bold("acorn summary") + f"  ({data['home']})")
