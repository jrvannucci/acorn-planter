...
acorn's whole offline story is redistribution: a bundle copies wheels onto
...
METADATA is RFC 822 -- both stdlib), so acorn's "no third-party runtime
...
OBLIGATIONS = {
    ...
    "unclassified": "a licence acorn doesn't recognize -- read it before "
                    "redistributing",
}
